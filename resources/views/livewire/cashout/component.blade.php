                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.lazy="fromDate" class="form-control flatpickr" placeholder="Click para elegir">
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.lazy="toDate" class="form-control flatpickr" placeholder="Click para elegir">
                    ...
                    <div class="col-sm-12 col-md-3 align-self-center d-flex justify-content-around">
                        ...
                        <a class="btn btn-dark m-auto"
                            href="{{ url('cashout/pdf' . '/' . $userid . '/' . $fromDate . '/' . $toDate) }}" target="_blank">Generar PDF</a>
                        @endif
                    </div>
