            ...
            <div class="modal-header">
                ...
                <div class="input-group">
                    <input type="text" wire:model="search" id="modal-search-input" autocomplete="off"
                        placeholder="Puedes buscar por nombre del producto, código ó categoría..." class="form-control">
                        ...
                        <table class="table table-bordered table-striped mt-1">
                            <thead class="text-white" style="background: #3B3F5C">
                                <tr>
                                    ...
                                    <th class="table-th text-center text-white">
                                        <button id="addSearchAll" wire:click.prevent="addAll" class="btn btn-info" {{count($products)> 0 ?
                                            '' : 'disabled' }}>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span>
                                            <img src="{{ asset('storage/products/' . $product->imagen ) }}" alt="img"
