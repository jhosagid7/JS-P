...
<body>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<td width="70%" class="text-left text-company" style="vertical-align: top; padding-top: 10px">
					@if($user)
					<span style="font-size: 16px"><strong>Reporte de Arqueo de Caja</strong></span>
                    @endif
					<br>
					@if($user)
        ...
        <table cellpadding="0" cellspacing="0" class="table-items" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="12%">PESO</th>
                    <th width="12%">DOLAR</th>
                    <th width="12%">TRANSF</th>
                    <th width="12%">PUNTO</th>
                    <th width="10%">ITEMS</th>
                    <th width="10%">T/DOLAR</th>
	...
	<section class="footer">
		...
		<table cellpadding="0" cellspacing="0" class="table-items" width="100%">
			<tr>
				<td width="20%">
					<span>JHONNY SYSTEMS JS-P v2</span>
				</td>
